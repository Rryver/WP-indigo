...
use app\components\textEditor\TextEditor;
        ...
        <div class="post__info">
          <a class="post__link-author" href="#">
            <img class="post__image-author" src="<?= Yii::getAlias("@web") ?> /images/post_author_icon.jpg"
                 alt="author-icon">
            <span class="post__author-name"><?= Yii::$app->params['user.nickname'] ?></span>
          </a>
...
<!--          --><?//= TextEditor::widget() ?>
        ...
        <!--      <div class="post__content">-->
        <!--        <img src="-->
          <? //= Yii::getAlias("@web") ?><!-- /images/post_image.jpg" alt="post-image" class="post__image">-->
        <!---->
        <!--        <div class="post__text">-->
<!--                  <p class="post__p">-->
